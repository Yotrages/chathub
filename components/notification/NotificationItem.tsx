  ...
  return (
    ...
    >
      <div className="flex items-start space-x-3">
        {/* Avatar */}
        <UserAvatar avatar={notification.senderId.avatar} username={notification.senderId.username || notification.senderId.name} className='w-10 h-10 rounded-full object-cover'/>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <p className="text-sm text-gray-900 dark:text-gray-100">
                <span className="font-medium">{notification.senderId.username || notification.senderId.name}</span>{' '}

...
export default function PrivacySettings({ settings, updateSettings }: PrivacySettingsProps) {
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-br from-white dark:from-gray-800 to-blue-50 dark:to-gray-800 p-6 rounded-2xl border border-blue-100 dark:border-blue-900/50 shadow-lg hover:shadow-xl dark:shadow-lg dark:hover:shadow-xl transition-all duration-300">
        ...
        <div className="space-y-3">
          {['public', 'friends', 'private'].map((option) => (
            <label key={option} className="flex items-center p-4 rounded-xl hover:bg-blue-50 dark:hover:bg-gray-700/50 cursor-pointer transition-all duration-200 border border-transparent hover:border-blue-200 dark:hover:border-blue-900/50">
              <input
                type="radio"
              ...
              />
              <span className="ml-4 text-sm font-medium text-gray-800 dark:text-gray-200 capitalize">{option}</span>
            </label>
          ))}
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-white dark:from-gray-800 to-green-50 dark:to-gray-800 p-6 rounded-2xl border border-green-100 dark:border-green-900/50 shadow-lg hover:shadow-xl dark:shadow-lg dark:hover:shadow-xl transition-all duration-300">
        ...
        <div className="space-y-3">
          {['everyone', 'friends', 'none'].map((option) => (
            <label key={option} className="flex items-center p-4 rounded-xl hover:bg-green-50 dark:hover:bg-gray-700/50 cursor-pointer transition-all duration-200 border border-transparent hover:border-green-200 dark:hover:border-green-900/50">
              <input
                type="radio"
              ...
              />
              <span className="ml-4 text-sm font-medium text-gray-800 dark:text-gray-200 capitalize">
      ...
      <div className="bg-gradient-to-br from-white dark:from-gray-800 to-purple-50 dark:to-gray-800 p-6 rounded-2xl border border-purple-100 dark:border-purple-900/50 shadow-lg hover:shadow-xl dark:shadow-lg dark:hover:shadow-xl transition-all duration-300">
        <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6 flex items-center">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={key} className="flex items-center justify-between p-4 bg-white/70 dark:bg-gray-700/50 rounded-xl border border-purple-200 dark:border-purple-900/50 hover:shadow-md dark:hover:shadow-lg transition-all duration-200">
              <div className="flex items-center">
                <Icon className="h-5 w-5 text-purple-600 dark:text-purple-400 mr-4" />
